...
#define NON_EDGE_JUMP_COUNT 6  /** how many consecutive readings from a non edged node before moving the user to that node*/
#define CHANGE_NODE_COUNT   3 /**how many consecute reading from an edged node before moving to that node*/
...
#define SHOULD_USE_STICKINESS 0 /** Flag for enabling/disabling the use of stickiness*/
